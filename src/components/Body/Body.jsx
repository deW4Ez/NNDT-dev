...
const Body = () => {
    return (
        <div className="bodyFrame">
            ...
            <p>Figure 1. The software architecture. Stars mark files that is not implemented in v0.0.1.</p>
            ...
            <p>Figure 2. The shape interpolation demo (sdf_multiple_files.py). first and forth shape are original, the second and third are generated by neural network.</p>
            <p>
                <img src="https://github.com/KonstantinUshenin/nndt/raw/main/images/mesh_segmentation.png?raw=true"></img>
            </p>
            <p>Figure 3. The mesh segmentation demo (mesh_segmentation.py). The left image is expected segmentation, and the right is predicted by NN.</p>
        </div>
    );
};
